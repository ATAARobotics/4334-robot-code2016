...
public class Ports {
	...
	public static final int DRIVE_RIGHT_1 = 0; //actual = 3
	public static final int DRIVE_RIGHT_2 = 1; //actual = 4
	
	//Talon SRX 
	public static final int SHOOTER = 0;
	public static final int SHOOTER_2 = 1;
	public static final int ARM = 2;
	public static final int ARM_2 = 3;
	
	public static final int INTAKE = 5;//actual 2; prac = 5
