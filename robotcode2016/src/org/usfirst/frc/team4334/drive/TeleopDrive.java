...
public class TeleopDrive implements Loopable{
	...
	public void teleopDrive(double deadzone, DriveMode desiredMode){
		...
		double x1 = Utils.deadzone(joy.getRawAxis(0), DriveConstants.JOY_DEADZONE);
		double y1 = -Utils.deadzone(joy.getRawAxis(1), DriveConstants.JOY_DEADZONE);
		double x2 = Utils.deadzone(joy.getRawAxis(4), DriveConstants.JOY_DEADZONE);
		double y2 = -Utils.deadzone(joy.getRawAxis(5), DriveConstants.JOY_DEADZONE);
